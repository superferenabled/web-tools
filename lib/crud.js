...
var processRequest_1 = require("./processRequest");
...
var CRUD = /** @class */ (function () {
    ...
    CRUD.create = function (model, req, extraData, cb) {
        ...
        cb = cb || function () { };
        extraData = extraData || {};
        data = processRequest_1.default.extractDataRequest(req, extraData);
    ...
    CRUD.read = function (model, req, extraData, cb) {
        ...
        extraData = extraData || {};
        data = processRequest_1.default.extractDataRequest(req, extraData);
        data = processRequest_1.default.cleanQueryOptions(data);
